...
public abstract class LibOpenConnect {
	...
	public static final int OC_COMPRESSION_MODE_NONE = 0;
	public static final int OC_COMPRESSION_MODE_STATELESS = 1;
	public static final int OC_COMPRESSION_MODE_ALL = 2;
	...
	public LibOpenConnect() {
		libctx = init("AnyConnect-compatible OpenConnect VPN Agent");
	}
	...
	public synchronized native int setCompressionMode(int mode);
